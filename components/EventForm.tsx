  ...
  const form = useForm<FormData>({
    ...
    defaultValues: {
      ...
      eventDate:
        ...
        new Date(initialData?.eventDate || new Date()),
    ...
    startTransition(async () => {
      try {
        ...
        if(mode=="create"){ 
            ...
            if(imageStorageId){
                await updateEventImage({eventId, storageId: imageStorageId as Id<"_storage">})
            }
            ...
            router.push(`/event/${eventId}`);
              ...
              if (imageStorageId || removeCurrentImage) {
                await updateEventImage({
                  eventId: initialData._id,
                  storageId: imageStorageId as Id<"_storage"> | null,
                });
              }
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-4">
            ...
            <div className="mt-1 flex items-center gap-4">
              {imagePreviewUrl || (!removeCurrentImage && currentImageUrl) ? (
